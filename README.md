...
* **19.11.2024** Обновлёна структура solve + в целом немного почищен проект (решение с дп удалил, но оно всё равно лежит в другой ветке) + обновлён CMakeLists, чтобы в VS отображались .h файлы
